      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          <button
            ...
            className="bg-gradient-to-r from-[#e31fc1] via-[#ff6b9d] to-[#ffc0cb] text-white px-6 py-3 rounded-xl font-semibold hover:shadow-2xl hover:shadow-[#e31fc1]/50 transition-all shadow-lg flex items-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
